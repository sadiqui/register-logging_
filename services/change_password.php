                ...
                <form action="" method='POST'>
                    ...
                    <div class="form-group">
                        ...
                        <input type='password' name="old_password"
                            ...
                            class="form-control form-control-lg <?php echo(isset($err['old_password_error'])) ? 'is-invalid' : ''; ?>">
                        <span
                            class="invalid-feedback"><?php echo(isset($err['old_password_error']) ? $err['old_password_error'] : ''); ?></span>
                    </div>
