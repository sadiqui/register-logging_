        ...
        <div class="col-md-6 mx-auto">
            <div class='card card-body  bg-light mt-5'>
                ...
                <form action="" method='POST'>
                    ...
                    <div class="row">
                        <div class='col'>
                            <a href="<?php echo(URLROOT); ?>/services/forget_password.php" class="btn  btn-block">Forget
                                Passsword?</a>

                        </div>

                        <div class='col'>
                            <a href="<?php echo(URLROOT); ?>/services/register.php" class="btn  btn-block">No account?
                                Register</a>
                        </div>
                    </div>
