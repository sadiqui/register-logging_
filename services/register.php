            ...
            <div class='card card-body  bg-light mt-2 mb-5'>
                ...
                <form action="" method='POST'>
                    ...
                    <div class="form-group">
                        ...
                        <input type='name' name="name" value="<?php echo(isset($data['name']) ? $data['name'] : ''); ?>"
                            class="form-control form-control-lg <?php echo(isset($err['name_error'])) ? 'is-invalid' : ''; ?>">
                        <span
                            class="invalid-feedback"><?php echo(isset($err['name_error']) ? $err['name_error'] : ''); ?></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' name="username"
                            ...
                            class="form-control form-control-lg <?php echo(isset($err['username_error'])) ? 'is-invalid' : ''; ?>">
                        <span
                            class="invalid-feedback"><?php echo(isset($err['username_error']) ? $err['username_error'] : ''); ?></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <span
                            class="invalid-feedback"><?php echo(isset($err['email_error']) ? $err['email_error'] : ''); ?></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' name="website"
                            ...
                            class="form-control form-control-lg <?php echo(isset($err['website_error'])) ? 'is-invalid' : ''; ?>">
                        <span
                            class="invalid-feedback"><?php echo(isset($err['website_error']) ? $err['website_error'] : ''); ?></span>
                    </div>
                    ...
                    <div class="row">
                        <div class='col'>
                            <a href="<?php echo(URLROOT); ?>/services/login.php" class="btn  btn-block">Have account? Login</a>
                        </div>
                    </div>
